...
def find_image_input(positive_class, seenclass2imageindexs, ori_seenclass2imageindexs, id2imagepixel, opt):
    ...
    # print("Available values in id2imagepixel:", id2imagepixel)
    # exit()
    # print("Available keys in id2imagepixel:", id2imagepixel.keys())
    # print("Trying to access key:", image_index)
    # print(id2imagepixel[image_index])
